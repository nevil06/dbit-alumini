          ...
          {newsItems.map((item, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3
                  className="font-[family-name:var(--font-sora)] font-bold text-xl leading-snug mb-3 group-hover:text-[#0B3D91] transition-colors"
                  style={{ color: "#0F172A" }}
                >
                  {item.title}
                </h3>
                ...
                <Link
                  href={item.href || "#"}
                  className="inline-flex items-center gap-1.5 text-xs font-semibold transition-all group/link mt-auto"
                  style={{ color: "#0B3D91" }}
                >
                  Read More
                  <ArrowRight
