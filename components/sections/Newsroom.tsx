...
export default function Newsroom() {
  return (
    <section className="py-[140px]" style={{ background: "#FFFFFF" }}>
          ...
          {newsItems.map((item, i) => (
            ...
            >
              ...
              <div className="p-[36px]">
                <div className="flex items-center gap-3 mb-[20px] text-[13px] text-gray-400">
                ...
                <h3
                  className="font-[family-name:var(--font-sora)] font-bold text-[1.1rem] leading-snug mb-[24px] group-hover:text-[#0B3D91] transition-colors mt-2"
                  style={{ color: "#0F172A" }}
                >
                  {item.title}
                </h3>

                <p className="text-[16px] leading-[1.7] mb-6 mt-[16px]" style={{ color: "#4A5568" }}>
                  {item.excerpt}
                </p>
